"""
Suite de Tests Síncronos para Angelus Sentinel - Reto 4
Actuando como Ingeniero de QA Senior especializado en testing automatizado con Pytest
Versión síncrona para compatibilidad sin pytest-asyncio
"""
...
class TestAdmissionsEndpoint:
    ...
    # 1. Happy Path Tests
    def test_valid_admission_success(self, valid_admission_payload):
    ...
    def test_unique_admission_id_generation(self, valid_admission_payload):
    ...
    def test_invalid_cedula_error(self):
    ...
    def test_special_characters_in_symptoms(self, valid_admission_payload):
    ...
    def test_policy_validation_error(self, valid_admission_payload):
    ...
    def test_firebase_error(self, valid_admission_payload):
    ...
    # 4. Integration Tests
    def test_service_calls_with_correct_parameters(self, valid_admission_payload):
...
class TestChatEndpoint:
    ...
    # 1. Happy Path Tests
    def test_valid_chat_message(self, valid_chat_payload):
    ...
    def test_sequential_validation_steps(self, valid_chat_payload):
    ...
    # 2. Edge Cases Tests
    def test_empty_chat_payload(self):
    ...
    # 3. Error Management Tests
    def test_gemini_service_error(self, valid_chat_payload, mock_gemini_service):
    ...
    # 4. Integration Tests
    def test_gemini_integration_with_patient_data(self, valid_chat_payload, mock_gemini_service):
...
class TestPatientsEndpoint:
    ...
    # 1. Happy Path Tests
    def test_existing_patient_retrieval(self):
    ...
    def test_patient_retrieval_by_different_ci(self):
    ...
    # 3. Error Management Tests
    def test_firebase_connection_error(self):
    ...
    # 4. Integration Tests
    def test_firebase_integration_priority(self, mock_firebase_db):
